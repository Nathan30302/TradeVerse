...
Direct instantiation for deployment platforms
"""
...
with app.app_context():
    ...
    # Auto-add missing columns for local dev (SQLite)
...
# Build FTS index on first request
@app.before_request
def _build_fts_once():
...
# Prometheus metrics not included in direct instantiation
