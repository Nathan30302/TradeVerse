...
class User(UserMixin, db.Model):
    ...
    # NOTE: These newer columns are deferred so baseline loads don't select them.
    # This keeps the app running if production DB migrations are temporarily behind.
